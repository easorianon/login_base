...
<head>
    <title>{{ config('app.name', 'Login') }} | Verificación de E-mail</title>
    <meta charset="utf-8" />
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-10">
                        ...
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h1 class="fw-bolder text-gray-900 mb-5">Verifica tu e-mail</h1>
                        <!--end::Title-->
                        <!--begin::Action-->
                        <div class="fs-6 mb-8">
                            <p class="fw-semibold text-gray-500">Por favor revisa tu e-mail para la verificación!</p>

                            <span class="fw-semibold text-gray-500">No recibiste el e-mail?</span>
                        ...
                        <!--begin::Link-->
                        <div class="mb-11">
                            <a href="javascript:void(0);" class="btn btn-sm btn-primary" onclick="submitForm()">Omitir por ahora</a>
